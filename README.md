...
Copy `AGENTS.md` into the root of a project where you run Codex:

```bash
cp AGENTS.md /path/to/your/project/AGENTS.md
```

Or copy the contents into an existing project-level `AGENTS.md` and merge with your own instructions.
